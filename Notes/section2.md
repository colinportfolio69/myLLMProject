...
1) Install Python3 library dependencies into the conda working environment. They are the following:
...
Based on the Pytorch documentation for starting [locally](https://pytorch.org/get-started/locally/)<sup>[1]</sup>, the cuda cores from Google Colab's GPU can be imported into the conda working environment by installing the following PyTorch components:
